  ...
  return q_device.submit([&](sycl::handler& h) {
    ...
    h.parallel_for(
        ...
        (sycl::nd_item<1> item) {
          ...
          //       NUM_THREADS_PER_CHECK, DOUBLES_PER_CHECK, POLYGON_DOUBLES,
          //       EQ_PLANE_OFFSET, VERTEX_A_OFFSET, VERTEX_B_OFFSET,
          //       INWARD_NORMAL_OFFSET, RANDOM_SCRATCH_OFFSET,
          //       POLYGON_VERTICES, narrow_phase_check_indices,
          //       gradient_W_pressure_at_Wo, element_offsets, vertex_offsets,
          //       element_mesh_ids, elements, vertices_W, inward_normals_W,
          //       geom_collision_filter_num_cols, total_checks_per_geometry,
          //       collision_filter_host_body_index,
          //       narrow_phase_check_validity, polygon_areas,

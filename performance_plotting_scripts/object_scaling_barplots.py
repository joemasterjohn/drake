...
def plot_demos_split(all_data, plot_dir, log_scale=False):
    ...
    plt.tight_layout()
    if log_scale:
        plt.savefig(f"{base_dir}/{plot_dir}/abs_time_split_log_object_scaling.png", dpi=300, bbox_inches='tight')
        print(f"Saved plot to {base_dir}/{plot_dir}/abs_time_split_log_object_scaling.png")
    else:
        plt.savefig(f"{base_dir}/{plot_dir}/abs_time_split_object_scaling.png", dpi=300, bbox_inches='tight')
        print(f"Saved plot to {base_dir}/{plot_dir}/abs_time_split_object_scaling.png")
    plt.show()
...
# Set style
    ...
    plt.tight_layout()
    if log_scale:
        plt.savefig(f"{base_dir}/{plot_dir}/abs_hydro_split_log_object_scaling.png", dpi=300, bbox_inches='tight')
        print(f"Saved plot to {base_dir}/{plot_dir}/abs_hydro_split_log_object_scaling.png")
    else:
        plt.savefig(f"{base_dir}/{plot_dir}/abs_hydro_split_object_scaling.png", dpi=300, bbox_inches='tight')
        print(f"Saved plot to {base_dir}/{plot_dir}/abs_hydro_split_object_scaling.png")
    plt.show()
...
if __name__ == "__main__":
    ...
    # demos = ["object_scaling"]
    demos = ["G + P 100 - 5 cm", "G + P 100 - 10 cm", "G + P 100 - 15 cm"]
    json_path_per_demo = {
        "G + P 100 - 5 cm": ("performance_jsons_bvh_Aug20", "objects_scaling_0.05_100"),
        "G + P 100 - 10 cm": ("performance_jsons_bvh_Aug20", "objects_scaling_0.1_100"),
        "G + P 100 - 15 cm": ("performance_jsons_bvh_Aug20", "objects_scaling_0.15_100")
    }
    main()
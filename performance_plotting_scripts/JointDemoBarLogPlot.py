...
def plot_demos_split(all_data, plot_dir, log_scale=False):
    ...
    plt.tight_layout()
    if log_scale:
        plt.savefig(f"{base_dir}/{plot_dir}/abs_time_split_log.png", dpi=300, bbox_inches='tight')
        print(f"Saved plot to {base_dir}/{plot_dir}/abs_time_split_log.png")
    else:
        plt.savefig(f"{base_dir}/{plot_dir}/abs_time_split.png", dpi=300, bbox_inches='tight')
        print(f"Saved plot to {base_dir}/{plot_dir}/abs_time_split.png")
    plt.show()
...
# Set style
    ...
    plt.tight_layout()
    if log_scale:
        plt.savefig(f"{base_dir}/{plot_dir}/abs_hydro_split_log.png", dpi=300, bbox_inches='tight')
        print(f"Saved plot to {base_dir}/{plot_dir}/abs_hydro_split_log.png")
    else:
        plt.savefig(f"{base_dir}/{plot_dir}/abs_hydro_split.png", dpi=300, bbox_inches='tight')
        print(f"Saved plot to {base_dir}/{plot_dir}/abs_hydro_split.png")
    plt.show()
...
if __name__ == "__main__":
    ...
    # demos = ["Barret", "Barret Convex No EC", "Anzu Convex No EC", "Anzu Convex"]
    demos = ["Barret Discrete SAP", "Barret Convex No EC"]
    # demos = ["Barret Convex With EC"]
    # demos = ["Anzu Convex With EC"]
    # demos = ["Anzu Convex No EC"]
    # demos = ["500 Envs", "800 Envs"]
    # demos = ["500 Envs"]
    json_path_per_demo = {
        "Barret Convex No EC": ("performance_jsons_BarretHand_convex", "barret"),
        "Barret Convex With EC": ("performance_jsons_BarretHand_convex_error_control", "barret"),
        "Barret Discrete SAP": ("performance_jsons_BarretHand", "barret"),
        "Anzu Convex No EC": ("performance_jsons_anzu", "anzu"),
        "Anzu Convex With EC": ("performance_jsons_anzu_error_control", "anzu"),

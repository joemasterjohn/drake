...
def calculate_number_of_elements(problem_size_data):
...
def main():
    ...
    for demo in demos:
        for run_type in run_types:
            ...
            print(f"Number of elements: {calculate_number_of_elements(all_data[demo][run_type]['problem_size'])}")
    ...
    plot_dir = "plots_gpu_comparison_anzu_Aug20"
...
if __name__ == "__main__":
    ...
    demos = ["Anzu Convex No EC", "Anzu Convex With EC"]
    json_path_per_demo = {

...
void BlockSparseCholeskySolver2::SetMatrix(
...
void BlockSparseCholeskySolver2::UpdateMatrix(
    const TriangularBlockSparseMatrix<double>& A) {
...
void BlockSparseCholeskySolver2::SolveInPlace(VectorX<double>* y) const {
...
VectorX<double> BlockSparseCholeskySolver2::Solve(
...
void BlockSparseCholeskySolver2::Factor() {
...
void BlockSparseCholeskySolver2::RightLookingSymmetricRank1Update(int j) {
